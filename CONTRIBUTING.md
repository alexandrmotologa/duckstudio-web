# Contributing to DuckStudio Web

Thank you for your interest in contributing to DuckStudio Web! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/duckstudio-web.git
   cd duckstudio-web
   ```
...
DuckStudio Web requires **Node.js 20+ LTS** and npm.
